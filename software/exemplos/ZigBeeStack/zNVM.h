...
*******************************************************************************/
        ...
        #define PutMACAddressByte( y, x )       NVMWrite( macLongAddrEE + y, (BYTE*)x, sizeof(LONG_ADDR) )
    #else
    ...
    #define GetKeyPair(x, y)                NVMRead( (BYTE *)x, y, sizeof(APSDeviceKeyPairSet) )
    #define PutKeyPair(x, y)                NVMWrite( x, (BYTE *)y, sizeof(APSDeviceKeyPairSet) )
    ...
    #define GetKeyPair(x, y)                NVMRead( (BYTE *)x, y, sizeof(APSDeviceKeyPairSet) )
    #define PutKeyPair(x, y)                NVMWrite( (NVM_ADDR *)x, (BYTE *)y, sizeof(APSDeviceKeyPairSet) )
